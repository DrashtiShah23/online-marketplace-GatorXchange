module.exports = {
  apps: [{
    ...
    script: 'application/csc648M0/Server/index.js'
  }],
  deploy: {
    production: {
      user: 'ubuntu',
      ...
      'post-deploy': 'npm install && pm2 startOrRestart /home/ubuntu/csc648-03-sp22-Team01/source/application/csc648M0/Server/ecosystem.config.js'
    }
  }
}